...
CREATE TABLE Children_Vaccination.medical_records(
    medicalid SERIAL PRIMARY KEY,
    pre_existing_condition VARCHAR(25),
    date_diagonised DATE NOT NULL,
    childid INT NOT NULL
)

DROP TABLE children_vaccination.medical_records
...
-- How many children recorded at least one disease
SELECT
count(pre_existing_condition)
FROM children_vaccination.medical_records
